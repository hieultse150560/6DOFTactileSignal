...
from PVTMedium import SpatialSoftmax3D, PVTMedium
...
parser.add_argument('--exp', type=str, default='singlePeople_PVTMedium_13_12', help='Name of experiment')
...
checkpoint = torch.load(args.exp_dir + 'ckpts/' + 'singlePeople_PVTMedium_13_12_0.0001_10_cp99.path.tar')
model.load_state_dict(checkpoint['model_state_dict'])
optimizer.load_state_dict(checkpoint['optimizer_state_dict'])
epochs = checkpoint['epoch']
loss = checkpoint['loss']
print("Loaded loss:", loss)
print("ckpt loaded:", args.exp_dir + 'ckpts/' + 'singlePeople_PVTMedium_13_12_0.0001_10_cp99.path.tar')
